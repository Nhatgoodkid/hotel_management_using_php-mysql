                ...
                <div id="detailCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/public/images/<?=$path?>.jpg" class="d-block w-100" width="600" height="400">
                        </div>
                        <div class="carousel-item">
                            <img src="/public/images/<?=$path?>_2.jpg" class="d-block w-100" width="600" height="400">
                        </div>
                        <div class="carousel-item">
                            <img src="/public/images/<?=$path?>_3.jpg" class="d-block w-100" width="600" height="400">
                        </div>
                    ...
                    <div class="subCarousel">
                        ...
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#detailCarousel" data-bs-slide-to="0" class="active">
                                <img src="/public/images/<?=$path?>.jpg" class="d-block w-100" width="80" height="70">
                            </button>
                            <button type="button" data-bs-target="#detailCarousel" data-bs-slide-to="1">
                                <img src="/public/images/<?=$path?>_2.jpg" class="d-block w-100" width="80" height="70">
                            </button>
                            <button type="button" data-bs-target="#detailCarousel" data-bs-slide-to="2">
                                <img src="/public/images/<?=$path?>_3.jpg" class="d-block w-100" width="80" height="70">
                            </button>
                        </div>
