...
<div class="wrapper_detail">
    ...
    <div class="list-group-inline btnConfirmation">
        <a id="" class="btn btn-lg p-3 px-5 fs-3 btn-secondary" href="http://localhost/Detail" target="_parent">Previous page</a>
        <a id="" onclick="addReserved()" class="btn btn-lg p-3 px-5 fs-3 btn-primary ml-5" href="http://localhost/Detail/Result">Alright, confirm the form</a>
    </div>
</div>
