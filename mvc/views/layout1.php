    ...
    <header>
        <div class="navigation">
            <nav class="navbar navbar-expand-md row d-sm-flex p-0">
                <a class="banner col-lg-5 col-md-2 col-sm-2 col-4 text-decoration-none" href="/Home">
                    ...
                    <ul class="nav text-light d-inline-block d-md-flex backgroundColorToggle">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu fs-3 px-4">
                                <li class="py-2"><a class="dropdown-item" href="http://localhost/Booking">Booking</a></li>
                                <li class="py-2"><a class="dropdown-item" href="http://localhost/History">History</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            <!-- <a class="nav-link" href="/Signin"><span class="signIn">Sign in</span></a> -->
