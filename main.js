...
function detailRoom(idRoom) {
  $.post("/Detail/Show", {detailPage: idRoom},
  function (data) {
  }
  );
        ...
        if (data == 1) {
          ...
          if (!isFillBook()) {
            $.ajax({
              ...
              // },
              success: function (response) {
                window.location.href = "/Detail/Confirmation";
              }
            });
          }
        }
